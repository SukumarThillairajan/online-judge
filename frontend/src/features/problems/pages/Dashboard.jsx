...
const Dashboard = () => {
  ...
  const handleLogout = async () => {
    try {
      ...
      // Clear the cached user regardless, so ProtectedRoute kicks us to /login
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8 flex items-start justify-between">
          ...
          <button
            ...
            className="px-4 py-2 rounded-md text-sm font-medium text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 transition shadow-sm"
          >
            Logout
          </button>
        </div>
